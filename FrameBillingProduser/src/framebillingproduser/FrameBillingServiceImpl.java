...
public class FrameBillingServiceImpl implements FrameBillingService {
	ArrayList<String> items = new ArrayList<String>();
	ArrayList<Float> price = new ArrayList<Float>();

	public void defaultList() {

	items.add("Ray Ban Frame");
	price.add((float) 3800.00);

	items.add("Oxydo Frame");
	price.add((float) 6000.00);

	items.add("Boss Orange Frame");
	price.add((float) 7500.00);

	items.add("Levi's Frame ");
	price.add((float) 25000.00);
